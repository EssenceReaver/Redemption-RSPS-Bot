...
public class CaptainDeathbeardScript implements Script {

    public static int afkAttempts = 0;
    public static Long lastUse = null;
    public static int deathbeardRetries = 0;
    ...
    public int onLoop() {
        ...
        if (deathbeardRetries > 80){
            return -1;
        }

        NPC archmageNpc = NPC.getClosestNpc("Captain Deathbeard");
        if (archmageNpc == null){
            deathbeardRetries++;
            return 250;
        }
